...
var StdKeyMaps = KeyMaps{
	...
	{"LinuxStd", "Standard Linux KeySeqMap", KeySeqMap{
		KeySeq{"Control+Tab", ""}:       KeyFunNextPanel,
		KeySeq{"Shift+Control+Tab", ""}: KeyFunPrevPanel,
		KeySeq{"F9", "o"}:               KeyFunNextPanel,
		KeySeq{"F9", "p"}:               KeyFunPrevPanel,
		KeySeq{"F9", "f"}:               KeyFunFileOpen,
		KeySeq{"F9", "b"}:               KeyFunBufSelect,
		KeySeq{"F9", "s"}:               KeyFunBufSave,
		KeySeq{"F9", "w"}:               KeyFunBufSaveAs,
		KeySeq{"F9", "k"}:               KeyFunBufClose,
		KeySeq{"F9", "c"}:               KeyFunExecCmd,
		KeySeq{"F9", "n"}:               KeyFunBufClone,
		KeySeq{"F9", "x"}:               KeyFunRegCopy,
		KeySeq{"F9", "g"}:               KeyFunRegPaste,
		KeySeq{"F9", "t"}:               KeyFunCommentOut,
		KeySeq{"F9", "i"}:               KeyFunIndent,
		KeySeq{"F9", "j"}:               KeyFunJump,
		KeySeq{"F9", "v"}:               KeyFunSetSplit, // view
	}},
