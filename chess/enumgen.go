...
var _ModesValueMap = map[string]Modes{`Pass and play`: 0, `Bot`: 1, `Online`: 2}

var _ModesDescMap = map[Modes]string{0: `ModePassAndPlay is a chess game played locally between two players.`, 1: `ModeBot is a chess game played against the computer (bot/AI).`, 2: `ModeOnline is a chess game played online through the Lichess API.`}

var _ModesMap = map[Modes]string{0: `Pass and play`, 1: `Bot`, 2: `Online`}
