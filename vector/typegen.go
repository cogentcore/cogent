...
var _ = types.AddType(&types.Type{Name: "cogentcore.org/cogent/vector.AlignView", IDName: "align-view", Doc: "AlignView provides a range of alignment actions on selected objects.", Embeds: []types.Field{{Name: "Frame"}}, Fields: []types.Field{{Name: "Anchor", Doc: "Anchor is the alignment anchor"}, {Name: "Vector", Doc: "the parent vector"}}})
...
var _ = types.AddType(&types.Type{Name: "cogentcore.org/cogent/vector.Tree", IDName: "tree", Doc: "Tree is a [core.Tree] that interacts properly with [Vector].", Embeds: []types.Field{{Name: "Tree"}}, Fields: []types.Field{{Name: "Vector", Doc: "the parent vector"}}})
