...
func (fv *FindView) SaveFindString(find string) {
	fv.Params().Find = find
	gi.StringsInsertFirstUnique(&fv.Params().FindHist, find, gi.AppearanceSettings.Params.SavedPathsMax)
	ftc := fv.FindText()
	if ftc != nil {
...
func (fv *FindView) SaveReplString(repl string) {
	...
	gi.StringsInsertFirstUnique(&fv.Params().ReplHist, repl, gi.AppearanceSettings.Params.SavedPathsMax)
	rtc := fv.ReplText()
	if rtc != nil {
...
func (fv *FindView) ReplaceAction() bool {
	...
	gi.StringsInsertFirstUnique(&fp.ReplHist, fp.Replace, gi.AppearanceSettings.Params.SavedPathsMax)
