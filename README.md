...
See the [Wiki](https://github.com/goki/gide/wiki) for more docs, discussion, etc.  [Install](https://github.com/goki/gide/wiki/Install) instructions (just standard `go get ...`).
