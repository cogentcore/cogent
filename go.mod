...
require (
	...
	goki.dev/cursors v0.0.19 // indirect
	goki.dev/enums v0.9.41 // indirect
	goki.dev/fi v0.1.5 // indirect
	goki.dev/glop v0.1.6 // indirect
	goki.dev/grog v0.0.14 // indirect
	goki.dev/laser v0.1.20 // indirect
	goki.dev/mat32/v2 v2.0.0-dev0.0.15 // indirect
	goki.dev/pi/v2 v2.0.0-dev0.0.13 // indirect
	goki.dev/prof/v2 v2.0.0-dev0.0.4 // indirect
	goki.dev/spell v0.1.2 // indirect
	goki.dev/svg v0.1.15 // indirect
	goki.dev/vci/v2 v2.0.0-dev0.0.18 // indirect
	goki.dev/vgpu/v2 v2.0.0-dev0.0.16 // indirect
