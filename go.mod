...
require (
	...
	goki.dev/laser v0.1.25
	goki.dev/mat32/v2 v2.0.0-dev0.0.20
	goki.dev/ordmap v0.5.7
	goki.dev/pi/v2 v2.0.0-dev0.0.18
	goki.dev/spell v0.1.7
	goki.dev/vci/v2 v2.0.0-dev0.0.23
)
...
require (
	...
	goki.dev/cursors v0.0.23 // indirect
