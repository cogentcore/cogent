...
var _ = types.AddType(&types.Type{Name: "cogentcore.org/cogent/code.SymTree", IDName: "sym-tree", Doc: "SymTree is a Tree that knows how to operate on FileNode nodes", Embeds: []types.Field{{Name: "Tree"}}, Instance: &SymTree{}})
...
var _ = types.AddType(&types.Type{Name: "cogentcore.org/cogent/code.CmdButton", IDName: "cmd-button", Doc: "CmdButton represents a [CmdName] value with a button that opens a [CmdView].", Embeds: []types.Field{{Name: "Button"}}, Instance: &CmdButton{}})
