...
var TextEditorType = gti.AddType(&gti.Type{Name: "cogentcore.org/cogent/code/code.TextEditor", IDName: "text-editor", Doc: "TextEditor is the Gide-specific version of the TextEditor, with support for\nsetting / clearing breakpoints, etc", Embeds: []gti.Field{{Name: "Editor"}}, Fields: []gti.Field{{Name: "Gide"}}, Instance: &TextEditor{}})
