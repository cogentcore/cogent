...
func (i *ArgVarTypes) UnmarshalText(text []byte) error {
	if err := i.SetString(string(text)); err != nil {
		log.Println("ArgVarTypes.UnmarshalText:", err)
	}
	return nil
}
...
func (i *FindLoc) UnmarshalText(text []byte) error {
	if err := i.SetString(string(text)); err != nil {
		log.Println("FindLoc.UnmarshalText:", err)
	}
	return nil
}
...
func (i *KeyFuns) UnmarshalText(text []byte) error {
	if err := i.SetString(string(text)); err != nil {
		log.Println("KeyFuns.UnmarshalText:", err)
	}
	return nil
}
...
func (i *SymScopes) UnmarshalText(text []byte) error {
	if err := i.SetString(string(text)); err != nil {
		log.Println("SymScopes.UnmarshalText:", err)
	}
	return nil
}
