...
var _KeyFunctionsValueMap = map[string]KeyFunctions{`None`: 0, `Needs2`: 1, `NextPanel`: 2, `PrevPanel`: 3, `FileOpen`: 4, `BufSelect`: 5, `BufClone`: 6, `BufSave`: 7, `BufSaveAs`: 8, `BufClose`: 9, `ExecCmd`: 10, `RectCopy`: 11, `RectCut`: 12, `RectPaste`: 13, `RegCopy`: 14, `RegPaste`: 15, `CommentOut`: 16, `Indent`: 17, `Jump`: 18, `SetSplit`: 19, `BuildProj`: 20, `RunProj`: 21}
...
var _KeyFunctionsMap = map[KeyFunctions]string{0: `None`, 1: `Needs2`, 2: `NextPanel`, 3: `PrevPanel`, 4: `FileOpen`, 5: `BufSelect`, 6: `BufClone`, 7: `BufSave`, 8: `BufSaveAs`, 9: `BufClose`, 10: `ExecCmd`, 11: `RectCopy`, 12: `RectCut`, 13: `RectPaste`, 14: `RegCopy`, 15: `RegPaste`, 16: `CommentOut`, 17: `Indent`, 18: `Jump`, 19: `SetSplit`, 20: `BuildProj`, 21: `RunProj`}
