...
func (ge *GideView) OpenPath(path gi.FileName) *GideView { //gti:add
	...
	if ok {
		os.Chdir(root)
		gide.SavedPaths.AddPath(root, gi.AppearanceSettings.Params.SavedPathsMax)
		gide.SavePaths()
...
func (ge *GideView) OpenProj(filename gi.FileName) *GideView { //gti:add
	...
	if ok {
		...
		gide.SavedPaths.AddPath(string(filename), gi.AppearanceSettings.Params.SavedPathsMax)
		gide.SavePaths()
		ge.SetName(pnm)
		ge.Sc.SetName(pnm)
		ge.ApplyPrefs()
